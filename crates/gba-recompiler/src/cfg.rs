...
use crate::decoder::{
    decode_arm, decode_thumb, decode_thumb_bl, read_arm, read_thumb, read_thumb_bl, ArmOp,
    Condition, DecodeError, Instruction, InstructionKind, Mode, ThumbOp, ROM_BASE,
};
...
mod tests {
    ...
    #[test]
    fn indirect_linked_call_splits_continuation_block() {
