...
pub fn shift_register(value: u32, kind: ShiftKind, amount: u8, carry_in: bool) -> ShiftResult {
    match kind {
        ...
        _ => match amount {
            ...
            32 => match kind {
                ShiftKind::Lsl => ShiftResult {
                    value: 0,
                    carry: value & 1 != 0,
                },
                ShiftKind::Lsr => ShiftResult {
                    value: 0,
                    carry: value & 0x8000_0000 != 0,
                },
                ShiftKind::Asr => ShiftResult {
                    value: if value & 0x8000_0000 != 0 {
                        u32::MAX
                    } else {
                        0
...
mod tests {
    ...
    fn shift_special_cases_are_explicit() {
        assert_eq!(
            shift_immediate(1, ShiftKind::Lsr, 0, true),
            ShiftResult {
                value: 0,
                carry: false
            }
        ...
        assert_eq!(
            shift_immediate(1, ShiftKind::Ror, 0, true),
            ShiftResult {
                value: 0x8000_0000,
                carry: true
            }
        ...
        assert_eq!(
            shift_register(1, ShiftKind::Ror, 0, true),
            ShiftResult {
                value: 1,
                carry: true
            }
        ...
        assert_eq!(
            shift_register(0x8000_0001, ShiftKind::Ror, 33, false),
            ShiftResult {
                value: 0xc000_0000,
                carry: true
            }
