...
impl Runtime {
    ...
    pub fn write16(&mut self, address: u32, value: u16) {
        ...
        match bus::decode(address).region {
            ...
            _ if address == mmio_devices::SOUNDBIAS.address => { let masked = value & mmio::SOUNDBIAS_WRITABLE_MASK; self.io.insert(address, masked as u8); self.io.insert(address + 1, (masked >> 8) as u8); }
...
mod mmio_device_tests {
    use super::*;
    use crate::bios::{IRQ_DMA0, IRQ_KEYPAD, IRQ_TIMER0};
    use crate::bus;
