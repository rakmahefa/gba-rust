...
pub use bios::{
    ...
    IO_END, IO_START, IRQ_DMA0, IRQ_DMA1, IRQ_DMA2, IRQ_GAMEPAK, IRQ_HBLANK, IRQ_KEYPAD, IRQ_SERIAL,
    IRQ_TIMER0, IRQ_TIMER1, IRQ_TIMER2, IRQ_TIMER3, IRQ_VBLANK, IRQ_VCOUNT, IWRAM_END,
